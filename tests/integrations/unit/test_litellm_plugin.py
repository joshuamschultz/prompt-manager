...
class TestLiteLLMPlugin:
    ...
    @pytest.mark.asyncio
    async def test_validate_compatibility_returns_true_for_all_formats(
        self, plugin: LiteLLMPlugin
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_config_returns_copy(self, plugin: LiteLLMPlugin) -> None:
    ...
    @pytest.mark.asyncio
    async def test_reinitialization_allowed(self, plugin: LiteLLMPlugin) -> None:
