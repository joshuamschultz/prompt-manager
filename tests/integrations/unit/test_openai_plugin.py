...
class TestOpenAIPlugin:
    ...
    def test_validate_compatibility_returns_true(
        self, plugin: OpenAIPlugin, text_prompt: Prompt
    ) -> None:
    ...
    def test_get_config_returns_copy(self, plugin: OpenAIPlugin) -> None:
    ...
    def test_reinitialization_allowed(self, plugin: OpenAIPlugin) -> None:
